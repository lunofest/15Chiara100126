...
function updateTimer() {
  const targetDate = new Date("january 10, 2026 21:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543884335548'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543884335548'; // Número para el primer botón
  const recipientNumber2 = '541131580132'; // Número para el segundo botón
